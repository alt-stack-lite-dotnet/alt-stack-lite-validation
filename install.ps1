...
Write-Host "==> Lite.Validation: установка зависимостей" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Готово. Активируйте venv: .\.venv\Scripts\Activate.ps1" -ForegroundColor Green
