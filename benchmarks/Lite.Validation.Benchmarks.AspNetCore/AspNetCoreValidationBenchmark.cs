...
{
    private WebApplicationFactory<Lite.Validation.Benchmarks.AspNetCore.App.AppEntryPoint> _factory = null!;
    ...
    public void Setup()
    {
        _factory = new WebApplicationFactory<Lite.Validation.Benchmarks.AspNetCore.App.AppEntryPoint>();
